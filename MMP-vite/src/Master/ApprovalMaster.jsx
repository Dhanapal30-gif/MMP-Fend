...
import { deleteApproval, deleteBom, downloadBom, downloadSearchBom, fetchApproval, fetchProdcutDetail, getBoMaster, getBomMasterFind, getPartcode, getProduct, getUserMailId, saveApprovalMaster, saveBomMaster, saveBomMasterUpload,  updateApproval,  updateBomMaster, uploadApprovalMaster } from '../ServicesComponent/Services';
         ...
         const handleExcelUpload = (e) => {
                ...
                if (data.success) {
                    setSuccessMessage(data.message || "Product upload Successfully");
                        ...
                        setHandleSubmitButton(true);
                        setShowUploadTable(false);
                        setShowBomTable(true);                    setFormData({ requesttype: "", issuancetype: "", componenttype: "", productgroup: [], approver1: [], approver2: [] });
                    fetchApprovalMaster();
                } else {
                    setErrorMessage(data.message || "Unknown error");
                    setShowErrorPopup(true);
