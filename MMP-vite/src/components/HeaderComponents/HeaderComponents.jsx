                ...
                <li className="dropdown-container" onMouseEnter={toggleServicesDropdown} onMouseLeave={closeServicesDropdown}>
                  ...
                  {servicesDropdown && (
                    <ul className="dropdown-menu">
                      ...
                      {(userRole.includes("Admin") || isScreenAllowed("TicketRaise")) && <li><Link to="/ticketRaise" className="dropdown-item" onClick={() => { closeServicesDropdown(); handleLinkClick(); }}>Ticket Raise</Link></li>}
                    </ul>
                  )}
                </li>
                ...
                <li className="dropdown-container" onMouseEnter={toggleServicesDropdown} onMouseLeave={closeServicesDropdown}>
                  ...
                  {servicesDropdown && (
                    <ul className="dropdown-menu">
                      ...
                      {(userRole.includes("Admin") || isScreenAllowed("locationMaster")) && <li><Link to="/locationMaster" className="dropdown-item" onClick={() => { closeServicesDropdown(); handleLinkClick(); }}>Location Master</Link></li>}
                    ...
                    <ul className="dropdown-menu">
                      ...
                      {(userRole.includes("Admin") || isScreenAllowed("UnitConsumptionCostReport")) && (
                        <li>
                          ...
                          >
                            Unit Component <br /> Consumption Cost
                          </Link>
                        </li>
                      )}
                    </ul>
